---
brief: Get to know me in less than five minutes
title: "My life in 5 minutes · Armand Thuillart"
headline: Get to know me in less than five minutes of reading.
---

import Stellarium1 from "@images/stellarium-1.webp";
import Stellarium2 from "@images/stellarium-2.webp";
import Xbox from "@images/xbox.webp";
import Gameboy from "@images/gameboy.webp";
import FlStudio from "@images/fl-studio.webp";
import C4D from "@images/c4d.webp";
import Uai from "@images/uai.webp";
...
<CollapsibleVideos
  title="Watch the best part of Apollo 13"
  videos={[
    {
...
<ImageGallery
  images={[
    { url: Stellarium1, alt: "A view of Mars from Stellarium" },
    { url: Stellarium2, alt: "A fragment of the Milky Way from Stellarium" },
  ]}
/>
...
<ImageGallery
  images={[
    { url: Xbox, alt: "Me playing racing games on Xbox" },
    { url: Gameboy, alt: "Me playing Pokémon on Game Boy" },
  ]}
/>

<CollapsibleVideos
  title="Curious what Sim City and Anno looked like?"
  videos={[
    {
...
<ImageGallery
  images={[
    { url: FlStudio, alt: "What FL Studio looks like" },
    { url: C4D, alt: "Some 3D rendering in Cinema 4D" },
  ]}
/>
...
<ImageGallery
  images={[
    { url: Uai, alt: "First day at UAI, Viña del Mar, Chile" },
    { url: Oxford, alt: "My daily walk to school in Oxford, UK" },
  ]}
/>
