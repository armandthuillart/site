---
metadata: { title: "Things I Believe · Armand Thuillart" }
headline: Things kept repeating to myself along the way...
title: Personal manifesto
date: 2026-01-12T12:00:00+01:00
---

## Shipping wins over strategy
...
- Get [1%](https://jamesclear.com/continuous-improvement) better every day

## Be ruthlessly truth seeking
- The truth can be painful
- You can change your mind if wrong
- Have strong opinions, loosely held
- Seek the collective truth, not just [one opinion](https://xyproblem.info/)

## Communication is the job
- [Clear writing](https://paulgraham.com/talk.html) is clear thinking
- Everyone needs to become a better writer
- Leaders step up to provide clarity when absent
- Document everything, even if it’s just for yourself
...
- Passion + boundaries > perfect "work-life balance"
- Your best work comes from following your [curiosity](https://en.wikipedia.org/wiki/ikigai)

## Demos > memos
- You could have built a prototype during the day
- Only build things you’re excited about yourself
